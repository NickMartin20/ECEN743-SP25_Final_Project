...
metrics_to_check = ["accuracy", "f1", "rouge", "bleu"]
...
# ---------------------------
# 5. ROUGE and BLEU Evaluation (Summarization)
# ---------------------------

predictions_rouge = []
references_rouge = []

for example in xsum['test'].select(range(30)):
...
results_dict = {
    ...
    "BLEU (XSum Summarization)": bleu_score,
}
